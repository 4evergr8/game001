...
Scene_SelectLanguage.prototype.onLanguageOk = function() {
    if (this._style === 'Window') {
        ...
        let str = this._languageWindow.currentExt() ;
        if (str == 'CN') {
            $gameSwitches.setValue(299, true);    
            $gameSwitches.setValue(300, false);    
        }
        else if (str == 'JP') {
            $gameSwitches.setValue(299, false);    
        ...
        let str = this._locales[this._index]
        if (str == 'CN') {
            $gameSwitches.setValue(299, true);    
            $gameSwitches.setValue(300, false);    
        }
    ...
    console.error(`style ${this._style}  switch 299:${$gameSwitches.value(299)}, switch:300   ${$gameSwitches.value(300)}`)
