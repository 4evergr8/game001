...
function callPictureAnime(pictureId, animationId) {
    const scene = SceneManager._scene;
    if (scene instanceof Scene_Map || scene instanceof Scene_Battle) {
        let picture = scene._spriteset._pictureContainer.children[pictureId - 1];
        let animation = $dataAnimations[animationId];
        picture.startAnimation(animation, false, 0);
    }
};
